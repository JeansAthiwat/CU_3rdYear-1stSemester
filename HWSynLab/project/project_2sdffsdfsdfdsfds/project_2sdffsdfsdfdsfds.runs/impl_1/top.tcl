namespace eval ::optrace {
  variable script "C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.cache/wt [current_project]
  set_property parent.project_path C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.xpr [current_project]
  set_property ip_output_repo C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc {{C:/Awork/y3s1/HWSynLab/project/project_2sdffsdfsdfdsfds/project_2sdffsdfsdfdsfds.srcs/constrs_1/imports/VGA Text Generation/const_ascii_test.xdc}}
