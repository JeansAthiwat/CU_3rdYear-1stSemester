...
namespace eval ::optrace {
  variable script "C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.runs/synth_1/top.tcl"
...
set_property parent.project_path C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.xpr [current_project]
...
set_property ip_output_repo c:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.cache/ip [current_project]
...
read_verilog -library xil_defaultlib {
  ...
  C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/sources_1/imports/new/vga_controller.v
  C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/sources_1/imports/new/top.v
}
...
read_xdc C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/constrs_1/imports/new/constraint.xdc
set_property used_in_implementation false [get_files C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/constrs_1/imports/new/constraint.xdc]

set_param ips.enableIPCacheLiteLoad 1

read_checkpoint -auto_incremental -incremental C:/Awork/y3s1/HWSynLab/project/project_faro/project_faro.srcs/utils_1/imports/synth_1/top.dcp
