...
HD_PWD='C:/Awork/y3s1/HWSynLab/Lab01/Lab01/Lab01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftA.tcl
